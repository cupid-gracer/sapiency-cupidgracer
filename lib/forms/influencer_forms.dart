...
class InfluencerForms {
  ...
  static BaseForm getCrowdSale(BuildContext ctx) => BaseForm(
    ...
    submitText: 'Continue',
    fields: {
      'crowdSaleEnabled': SwitchFormField(
          label: 'Click here to active your crowdsale'
      ),
  ...
  static BaseForm getSummary(BuildContext ctx) => BaseForm(
    ...
    fields: {
      'crowdSaleEnabled': SwitchFormField(
          label: 'I confirm that I provide a valid data'
      ),
    },
    onSubmit: (data, ctx) {
  ...
  static void gotoNext(Map<String, String> data, BuildContext ctx, int nextStep) {
