          ...
          child: InkWell(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                color: Colors.transparent,
                border:
                    Border.all(color: keyboardUIConfig.primaryColor, width: 0),
              ),
              child: Container(
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  color: text == "face" || text == "del"
                      ? Colors.transparent
                      : keyboardUIConfig.digitFillColor,
                ),
                child: text == "face"
                    ? Image(image: AssetImage(AppImages.facePIN))
                    : text == "del"
                        ? Image(image: AssetImage(AppImages.backspace))
                        : Center(
                            child: Text(
                              text,
...
class AlignedGrid extends StatelessWidget {
  ...
  const AlignedGrid({Key key, this.children, this.keyboardSize})
