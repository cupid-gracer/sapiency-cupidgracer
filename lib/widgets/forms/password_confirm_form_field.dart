...
class PasswordConfirmFormField extends StatefulWidget {
  ...
  factory PasswordConfirmFormField.formField(
      PasswordConfirmFormField prev, {
        String name,
...
class _PasswordFormFieldState extends State<PasswordConfirmFormField> with SapiencyInputDecoration {
  bool _isHidden = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          decoration: standardInputDecoration(suffix: InkWell(
              onTap: _toggleConfirmPasswordShow,
              child: Icon(
                _isHidden ? Icons.visibility_rounded : Icons.visibility_off_rounded,
                color: SapiencyTheme.hintColor,
              )
          ...
          validator: (value) =>   Validator.confirm_password(pwd, value),
          // onSaved: _saveData,
          textInputAction: widget.inputAction,
          onFieldSubmitted: (_) => widget.focusNext(),
        ),
  ...
  void _toggleConfirmPasswordShow() =>
    setState(() {
